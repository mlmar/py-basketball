    ...
    <div className="app">
      ...
      <header className="hero">
        <div>
          ...
          <p className="subtext">
            Your centralized hub for lineup decisions, category tracking, and
            waiver intel.
          </p>
        ...
        <div className="hero-card">
          ...
          <p className="tiny-text">
            Target categories: <strong>FG%</strong>, <strong>AST</strong>,{" "}
            <strong>3PM</strong>, <strong>STL</strong>.
          </p>
        </div>
      </header>
      ...
      <section className="section">
        ...
        <p className="section-sub">
          A quick glance at the matchups you&apos;re aiming to control.
        </p>
      ...
      <section className="section grid-2">
        <div className="card">
          ...
          <p className="section-sub">
            Players worth monitoring or adding based on recent performance.
          </p>
