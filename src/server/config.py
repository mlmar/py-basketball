...
SUPABASE_TRENDING_ANALYSIS_STATUS_TABLE: str = os.environ.get('SUPABASE_TRENDING_ANALYSIS_STATUS_TABLE')
SUPABASE_TRENDING_ANALYSIS_DATA_TABLE: str = os.environ.get('SUPABASE_TRENDING_ANALYSIS_DATA_TABLE')